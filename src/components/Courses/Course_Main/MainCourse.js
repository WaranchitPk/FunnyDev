...
import {Grid, Paper, Divider, Typography, List, ListItem} from "@material-ui/core";
import {TitleMain, ChartMain} from "../";
...
const MainCourse = ({btState, Open, Close, stylesDash, dataT}) => {
    return (
        <div>
